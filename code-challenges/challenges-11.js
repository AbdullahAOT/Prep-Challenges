...
function fullName(arr) {
    let resultArray=[];
    arr.map(function(studentObject){
        resultArray.push(studentObject.firstName+" "+studentObject.lastName);
    });
    return resultArray;
}
// -------------------------------------------------------------------------------------------------------
...
function gradesAvg(arr) {
    let resultArray=[];
    arr.map(function(studentObject){
        let objectWithAvg=studentObject;
        let gradesSum=0;
        studentObject.gradsList.map(function(grade){
            gradesSum+=grade;
        });
        objectWithAvg.avg=gradesSum/studentObject.gradsList.length;
        resultArray.push(objectWithAvg);
    });
    return resultArray;
}
// -------------------------------------------------------------------------------------------------------
